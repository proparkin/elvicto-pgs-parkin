...
namespace App\Http\Controllers\API\FtpMotion;

use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use App\Jobs\FtpMotion\{MainProcessCameraImageFtpMotion,ProcessParkingSlotsCoordinateFtpMotion,DetectNumberPlateSlotsCoordinateFtpMotion};
...
class CameraUploadFtpController extends Controller
{
    ...
    // {
    //     ProcessParkingSlotsCoordinateFtpMotion::dispatch();
    // }

    // public function DetectNumberPlateSJob()
    // {
    //     DetectNumberPlateSlotsCoordinateFtpMotion::dispatch();
    // }
    ...
    public function getLiveStream()
    {
        ...
        {
            $cameraJobs[] = new MainProcessCameraImageFtpMotion($batchFolders, $index + 1);
        }
