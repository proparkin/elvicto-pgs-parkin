...
class DetectNumberPlateSlotsCoordinateOne implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try
        {
            ...
            $folderPath = '/root/slot_images/new_parkin_slot_images_-19_0';
            ...
            else 
            {
                ...
                foreach ($json as $data) 
                {
                    ...
                    $casesImage .= "WHEN {$id} THEN " . ($plateNumber ? "'storage/new_parkin_slot_images_-19_0/{$imageValue}.jpg'" : "NULL") . " ";
