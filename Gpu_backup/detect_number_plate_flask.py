...
def process_folder_api():
    try:
        ...
        detector = VehicleNumberDetector()   # ✅ FIXED
        ...
        for i in range(0, len(image_data), batch_size):
            ...
            # save_debug=True for first batch only (for testing)
            save_debug = (i == 0)  
            batch_results = detector.detect_vehicles_batch(images, slots, save_debug=save_debug)
